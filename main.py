...
def main():
    ...
    messages = []
    messages.append(SystemMessage(content="""你是一位 **人才資料分析師**。以下為【學生自我介紹】，請 **只依原文** 用繁體中文條列萃取：① 興趣與關注主題 ② 技能／經驗／學習線索 ③ 價值觀與理想工作條件 ④ 疑慮或卡關。**勿**臆測文中沒有的事實，**勿**在此步推薦職業或打分。  """))
    messages.append(HumanMessage(content="""我是一名高二學生，目前對未來的方向有點迷惘。  
